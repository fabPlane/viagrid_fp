...
| `firmware/` | CH552G firmware (SDCC), tests, host tool, udev rule |
...
- [x] CH552 firmware (`firmware/`): YKUSH protocol with YKUSH USB IDs, so `ykushcmd` works.
  It builds to about 2.5 KB and passes descriptor, unit and `ykushcmd` end-to-end tests. It has not
